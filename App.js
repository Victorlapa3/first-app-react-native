...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={password ? require('./assets/unlock.png') : require('./assets/padlock.png')}
        style={styles.image}
        resizeMode="contain" />

      <Text style={[styles.buttonText, styles.buttonPassword, { fontSize: 20 }]}>{password ? password : "Senha não gerada"}</Text>
      ...
      <Pressable
        ...
        disabled={!password}
      >
        <Text style={styles.buttonText}>{password ? "COPIAR" : "COPIAR"}</Text>
      </Pressable>
